...
//       chucvu: "Sáng lập & Điều hành",
//       email: "tai@2tfreshmarket.vn",
//       // ⬇️ Sử dụng key trong AssetMap, nếu key là 'AnhKhongTonTai', nó sẽ fallback về PLACEHOLDER_AVATAR_URL
//       anhKey: "Anhchinh", // Đổi thành 'AnhKhongTonTai' để xem placeholder hiện ra
//     },
//   ];
const founders = [
  {
...
const MissionIcon = () => (
  ...
  >
    <path d="M12 2L2 7l10 5 10-5L12 2zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
  </svg>
); // Tòa nhà/Kim tự tháp
const FeaturesIcon = () => (
  <svg
...
const FreshIcon = ({ color }) => (
  ...
  >
    <path
      d="M12 2l3.09 6.32L22 9.27l-5 4.87 1.18 6.88L12 18.27l-6.18 3.55L7 14.14l-5-4.87 6.91-1.05z"
      fill="currentColor"
    ></path>
  </svg>
);
...
const ExchangeIcon = ({ color }) => (
  ...
  >
    ...
    <path d="M20.88 18.12a2.43 2.43 0 0 0 1.25-2.61L20 8h-9l3.5 3.5m-3.5 2.5L12 12m-3-3L6 6"></path>
  </svg>
); // Đổi trả
...
const GiftIcon = ({ color }) => (
  ...
  >
    ...
    <path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"></path>
  </svg>
); // Gift
    ...
    >
      <img
        ...
        onError={(e) => {
          ...
          if (e.target.src !== ON_ERROR_FALLBACK_URL) {
            e.target.src = ON_ERROR_FALLBACK_URL;
          }
        }}
      />
      <h3 style={nameStyle}>{member.hoten}</h3>
      <p style={roleStyle}>{member.chucvu}</p>
      <a href={`mailto:${member.email}`} style={emailStyle}>
        {member.email}
      </a>
    </div>
  );
      ...
      content: (
        <>
          ...
          >
            ...
            >
              <FreshIcon color={primaryColor} />
              **Nguồn gốc rõ ràng:** Cam kết cung cấp trái cây tươi ngon, được
            ...
            >
              ...
              **Giao diện tối ưu:** Dễ sử dụng, thân thiện và tối ưu trên mọi
              thiết bị di động.
            </li>
            <li
              style={{
            ...
            >
              ...
              **Đặt hàng nhanh:** Quy trình đơn giản, giúp khách hàng tiết kiệm
              tối đa thời gian.
            </li>
            <li
              style={{
            ...
            >
              <ExchangeIcon color={primaryColor} />
              **Hỗ trợ nhanh:** Đội ngũ luôn sẵn sàng giải đáp mọi thắc mắc.
            </li>
          </ul>
        </>
      ),
        ...
        <>
          ...
          <ul style={listStyle}>
            <li style={listItemStyle}>
              <FreshIcon color={primaryColor} />
              Hiển thị danh mục trái cây chi tiết theo mùa, xuất xứ, giá cả, và
              chất lượng.
            </li>
            <li style={listItemStyle}>
              <CartIcon color={primaryColor} />
              Hệ thống giỏ hàng thông minh và hỗ trợ thanh toán linh hoạt (COD,
              chuyển khoản).
            </li>
            <li style={listItemStyle}>
              <InfoIcon color={primaryColor} />
              Cung cấp kiến thức về lợi ích sức khỏe và hướng dẫn bảo quản cho
              từng loại trái cây.
            </li>
            <li style={listItemStyle}>
              <GiftIcon color={primaryColor} />
              Hệ thống thông báo và ưu đãi cho các chương trình khuyến mãi.
            </li>
          </ul>
          ...
          <ul style={listStyle}>
            <li style={listItemStyle}>
              <CartIcon color={secondaryColor} />
              Mở rộng sản phẩm sang nước ép trái cây tươi, sinh tố đóng chai, và
              combo dinh dưỡng.
            </li>
            <li style={listItemStyle}>
              <ClockIcon color={secondaryColor} />
              Tích hợp hệ thống giao hàng siêu tốc (Express Delivery) trong vòng
              2 giờ cho nội thành.
            </li>
            <li style={listItemStyle}>
              <MobileIcon color={secondaryColor} />
              Phát triển ứng dụng di động riêng để tối ưu hóa trải nghiệm đặt
              hàng và theo dõi đơn hàng.
            </li>
            <li style={listItemStyle}>
              <ShieldIcon color={secondaryColor} />
              Liên tục cải thiện hiệu suất website và trải nghiệm tương tác để
              mua sắm trơn tru nhất.
            </li>
          </ul>
        </>
      ),
    ...
    policy: {
      ...
      content: (
        <>
          ...
          >
            <p
              style={{ fontWeight: "600", color: "#007bff", fontSize: "1rem" }}
            >
              Quy trình đặt hàng:
            </p>
            <ul
            ...
            >
              ...
              <li>Điền thông tin giao hàng (Tên, Địa chỉ, SĐT).</li>
              <li>
                Chọn phương thức thanh toán (COD, Chuyển khoản ngân hàng).
              </li>
              <li>Xác nhận đơn hàng và nhận thông báo.</li>
            </ul>
            <p
            ...
            <p style={{ fontSize: "0.9rem" }}>
              Chúng tôi chấp nhận thanh toán khi nhận hàng (COD) và chuyển khoản
              ngân hàng. Thông tin chuyển khoản sẽ được cung cấp khi xác nhận
              đơn hàng.
            </p>
          </div>
          ...
          >
            <p
              style={{ fontWeight: "600", color: "#dc3545", fontSize: "1rem" }}
            >
              Điều kiện đổi trả:
            </p>
            <ul
            ...
            >
              <li>
                Sản phẩm bị dập nát, hư hỏng do quá trình vận chuyển hoặc trước
                khi giao hàng.
              </li>
              <li>
                Giao sai loại trái cây hoặc sai số lượng so với đơn đặt hàng.
              </li>
              <li>
                Thời gian yêu cầu đổi trả phải trong vòng{" "}
                <span style={{ fontWeight: "bold" }}>2 giờ</span> kể từ khi nhận
                hàng.
              </li>
              <li>
                Sản phẩm đã được sử dụng quá 50% hoặc để quá thời gian quy định
            ...
            <p style={{ fontSize: "0.9rem" }}>
              Khách hàng vui lòng chụp ảnh sản phẩm lỗi và liên hệ ngay với
              hotline/email hỗ trợ. Chúng tôi sẽ tiến hành xác minh và gửi sản
              phẩm thay thế hoặc hoàn tiền trong vòng 24 giờ.
            </p>
            <p
              style={{
                fontWeight: "600",
            ...
            <p style={{ fontSize: "0.9rem" }}>
              Chúng tôi không áp dụng đổi trả cho các trường hợp sản phẩm đã
              được sử dụng quá 50% hoặc để quá thời gian quy định.
            </p>
          </div>
        </>
      ),
    ...
    <div style={containerStyle}>
      <div style={contentWrapperStyle}>
        ...
        <p style={subtitleStyle}>
          Chất lượng, Tươi ngon và Tiện lợi là cam kết hàng đầu của chúng tôi.
        </p>
